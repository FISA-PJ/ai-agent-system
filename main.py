...
# Query = {'userId':'kimnewlywed','noticeNumber': '0000060865','user_info': {'primeType': '신혼부부', 'registrationNumber': '9503151234567', 'subType': '우선공급', 'userName': '김신혼'}, 'message': "전매 제한이 뭐야? 이 아파트 공고의 전매 제한 기간이 어떻게 돼?"}
# def answer_question(Query) : 
#     global flag, current_state
